...
class OperationalMetricsTest {
    ...
    void exportsOperationalPaymentAndOutboxGauges() {
        ...
        when(payments.countByStatusAndUpdatedAtBefore(eq(PaymentStatus.PROCESSING), any(Instant.class))).thenReturn(2L);
        ...
        new OperationalMetrics(payments, outbox, Duration.ofMinutes(10)).bindTo(registry);
